...
?>
	...
	<div id="clan-new-alliance">	
		...
		?>
		<form class="clan-form" action="view.php?page=clan&tab=diplomacy_alliance" method="post">
				<ul>
					
					<b>Clan</b><li><input id="filter-alliance" type="text" /><select id="clan-alliance-form-clan" name="clan-alliance-form-clan">
						<?php
...
<script type="text/javascript">
	...
	$(function() {
        $('#clan-alliance-form-clan').filterByText($('#filter-alliance'), false);
...
function handleNewAllianceForm($db, $clan_id, $clan_company)
{
	...
	else
	{
		...
		header("Location: view.php?page=clan&tab=diplomacy_alliance");
		exit();
	}		
	return $errors;
}
		...
		?>
				<div class="stat" style="margin-left:-20px;">
					...
					<div class="stat-right">
						...
						{
						?>
							<a class="leftbutton" href="view.php?page=clan&tab=diplomacy_alliance&cancel=<?=$Alliance['id']?>">
								Cancel
							</a>
						<?php 
						}
		...
		?>
				<div class="stat" style="margin-left:-20px;">
					...
					<div class="stat-right">
						...
						{
						?>
							<a class="leftbutton" href="view.php?page=clan&tab=diplomacy_alliance&cancelAR=<?=$Alliance['id']?>">
								Cancel
							</a>
						<?php 
						}
				...
				<div class="stat" style="margin-left:-20px;">
					...
					<div class="stat-right">
						...
						?>							
							...
							<a class="leftbutton" href="view.php?page=clan&tab=diplomacy_alliance&acceptAR=<?=$Alliance['id']?>">
								Accept
							</a>
						<?php 
						}
